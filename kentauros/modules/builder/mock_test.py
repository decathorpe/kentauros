...
MOCK_DEF_CONFIG_FOUND = os.path.exists("/etc/mock/default.cfg")
...
class MockTest(unittest.TestCase):
    ...
    @unittest.skipUnless(MOCK_DEF_CONFIG_FOUND, "No default configuration file found.")
    ...
    def test_get_dist_from_f27_config(self):
